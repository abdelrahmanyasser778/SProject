...
const AdminShowGrade = () => {
  return (
    ...
    <div className="user-address-card my-3 px-2">
        ...
        <Row className="">
            <Col xs="12" className="d-flex">
                <div className="p-2">الدرجة :</div>
                <div className="p-1 item-delete-edit">90/100</div>
            </Col>
        </Row>
        <Row className="mt-5">
            <Col xs="10" sm="8" md="6" className="">
                <div className="admin-content-text">اضافة درجة جديدة</div>

                <input
                    type="password"
                    className="input-form d-block mt-3 px-3"
                    placeholder="ادخل  الدرجة الجديدة "
                />
            </Col>
        </Row>
        ...
        <Row>
            <Col xs="10" sm="8" md="6" className="d-flex justify-content-end ">
                <button className="btn-save d-inline mt-2 ">حفظ  الدرجة</button>
            </Col>
        </Row>
    </div>
</div>
